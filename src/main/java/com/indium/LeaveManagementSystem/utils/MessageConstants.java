package com.indium.LeaveManagementSystem.utils;
...
public class MessageConstants {
    ...
    public static final String BAD_REQUEST_DELETE ="Error while deleting details";
    public static final String EMPLOYEE_BY_ID ="Employee Details By Id";
